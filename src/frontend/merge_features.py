...
class MergeFeat(object):
    ...
    def merge_label(self, binary_label_file_list, new_feat_file_list, out_feat_file_list):
        """
        ...
        for i in range(utt_number):
            ...
            new_features = io_funcs.load_binary_file(
    ...
    def merge_data(self, binary_label_file_list, new_feat_file_list, out_feat_file_list):
        ...
        for i in range(utt_number):
            ...
            if (lab_frame_number - feat_frame_number) > 5:
                base_file_name = new_feat_file_list[i].split(
                    '/')[-1].split('.')[0]
