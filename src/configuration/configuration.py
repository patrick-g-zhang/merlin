...
class configuration(object):
    ...
    def user_configuration(self,configFile=None):
        ...
        user_options = [
            ...
            ('state_number'      , 5                                                     ,    'Labels', 'state_number'),
...
#            self.stream_lr_weights.append(0.5)
    ...
    def logging_configuration(self):
        ...
        try:
            ...
            logging.warning('no logging configuration file provided - using default (console only, DEBUG level)')
            ...
            if not os.path.exists(self.log_path):
                os.makedirs(self.log_path, 0o777)
