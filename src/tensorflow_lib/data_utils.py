...
def transform_data_to_3d_matrix(data, seq_length=200, max_length=0, merge_size=1, shuffle_data = True, shuffle_type = 1, padding="right"):
    num_of_utt = len(data)
    feat_dim   = data[list(data)[0]].shape[1]
...
if __name__ == '__main__':
    out_dir = "/home/gyzhang/merlin/egs/slt_arctic/s1/experiments/slt_arctic_full/acoustic_model/inter_module/nn_norm_mgc_lf0_vuv_bap_187"
    inp_dir = "/home/gyzhang/merlin/egs/slt_arctic/s1/experiments/slt_arctic_full/acoustic_model/inter_module/nn_no_silence_lab_norm_425"
    out_file_list = [out_dir+'/arctic_a0001.cmp', out_dir+'/arctic_a0002.cmp', out_dir+'/arctic_a0003.cmp']
    inp_file_list = [inp_dir+'/arctic_a0001.lab', inp_dir+'/arctic_a0002.lab', inp_dir+'/arctic_a0003.lab']
    read_data_from_file_list(inp_file_list,out_file_list,425,187,True)